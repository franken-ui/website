<div>
  <div className="flex flex-wrap gap-2">
    <button className="uk-btn uk-btn-default mr-2" type="button" data-uk-toggle="target: #offcanvas-slide">
      Slide
    </button>
    <button className="uk-btn uk-btn-default mr-2" type="button" data-uk-toggle="target: #offcanvas-push">
      Push
    </button>
    <button className="uk-btn uk-btn-default mr-2" type="button" data-uk-toggle="target: #offcanvas-reveal">
      Reveal
    </button>
    <button className="uk-btn uk-btn-default mr-2" type="button" data-uk-toggle="target: #offcanvas-none">
      None
    </button>
  </div>
