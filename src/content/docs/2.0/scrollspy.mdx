...
text: Scrollspy
title: Scrollspy
lead: Trigger events and animations while scrolling your page.
meta:
...
Typically, classes from the [Animation component](/docs/2.0/animation) are used together with the Scrollspy component.

```html
<div data-uk-scrollspy="cls:uk-anmt-fade"></div>
```

<Snippet component="scrollspy.basic" />

This example uses the `repeat: true` option. Scroll up and down to see the triggered animations. The layout is made with the [Card component](/docs/2.0/card).
...
<Snippet component="scrollspy.groups" />
...
<Snippet component="scrollspy.groups_1" />
...
| `scroll`  | Boolean               | `false`     | Adds the [Scroll component](/docs/2.0/scroll) to its links.       |
