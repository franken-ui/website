...
<Snippet component="notification.basic" />
...
<Snippet component="notification.html_message" />
...
<Snippet component="notification.position" />
...
<Snippet component="notification.danger" />

## Close all

You can close all open notifications by calling `UIkit.notification.closeAll()`.

<Snippet component="notification.close_all" />
