...
<Snippet component="tooltip.basic" />
...
<Snippet component="tooltip.alignment" />
...
<Snippet component="tooltip.delay" />
...
| `animation` | String | `uk-anmt-scale-up` | Space-separated names of [animations](/docs/2.0/animation). Comma-separated for animation out.           |
