...
<Snippet component="typography.basic" />
...
<Snippet component="typography.headings" />
...
<Snippet component="typography.hero" />
...
<Snippet component="typography.heading_styles" />

## Paragraph

<Snippet component="typography.paragraph" />

## Blockquote

<Snippet component="typography.blockquote" />

## Inline code

<Snippet component="typography.codespan" />
...
| `.uk-text-xs`       | <span class="uk-text-xs">Add this class to apply an extra small font size.</span>                                    |
...
| `.uk-text-lg`       | <span class="uk-text-lg">Add this class to apply a large font size.</span>                                           |
...
<Snippet component="typography.text_background" />