...
**2\.** Optionally, you can include a pre-built (`~58.83 kB` gzipped) Tailwind CSS utility classes to complement with Franken UI. These utility classes are pre-extracted from Tailwind CSS. If you find this too large, you can always switch to a proper build process.
